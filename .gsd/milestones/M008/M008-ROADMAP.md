...
| S02 | Governed ledger persistence and request markers | high | S01 | ⬜ | New requests persist only the allowed evidence shape for the tenant and carry per-request governance markers so request detail can later show what policy applied at write time. |
