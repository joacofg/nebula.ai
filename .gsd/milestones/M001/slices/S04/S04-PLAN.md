...
- [ ] **T02: Expand Playground and Observability proof surfaces for day-1 trust** `est:1h15m`
...
- [ ] **T03: Lock the day-1 value story with backend and console proof tests** `est:1h`
