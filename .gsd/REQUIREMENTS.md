...
- Primary owning slice: M007/S04
- Supporting slices: M007/S03, M007/S05
- Validation: Validated by M007 close-out. The next operator action is legible from page structure and evidence framing across Observability and policy preview, confirmed by `docs/m007-integrated-proof.md` and the final focused 6-file, 39/39-test console Vitest bundle.
...
- Validation: Validated by M008/S01 through passing targeted verification: ./.venv/bin/pytest tests/test_governance_api.py tests/test_service_flows.py tests/test_hosted_contract.py and ./.venv/bin/pytest tests/test_chat_completions.py -k ledger && ./.venv/bin/pytest tests/test_embeddings_api.py, plus console Vitest coverage for policy surfaces. Tenant policy now carries explicit evidence_retention_window and usage-ledger rows persist request-time retention/expiration markers via the centralized governed persistence seam.
...
### R068 — Broad RBAC or enterprise permissions redesign is not part of M008.
- Class: anti-feature
- Status: out-of-scope
...
### R069 — Dashboard-heavy analytics expansion around evidence governance is not part of M008.
- Class: anti-feature
- Status: out-of-scope
...
### R071 — Raw prompt or raw response persistence expansion is not part of M008.
- Class: anti-feature
- Status: out-of-scope
...
### R072 — Generic compliance/audit platform features unrelated to Nebula’s request/policy/evidence core are not part of M008.
- Class: anti-feature
- Status: out-of-scope
...
| R054 | launchability | validated | M007/S04 | M007/S03, M007/S05 | Validated by M007 close-out. The next operator action is legible from page structure and evidence framing across Observability and policy preview, confirmed by `docs/m007-integrated-proof.md` and the final focused 6-file, 39/39-test console Vitest bundle. |
...
| R064 | constraint | validated | M008/S05 | M008/S01, M008/S02, M008/S03, M008/S04 | Validated by M008/S05 through the bounded integrated-governance walkthrough in `docs/m008-integrated-proof.md`, its discoverability links, and focused pytest/Vitest coverage that explicitly rejects drift into payload capture, soft-delete recovery semantics, retention-dashboard sprawl, or hosted authority. The assembled milestone story stays inside request/policy/evidence governance only. |
