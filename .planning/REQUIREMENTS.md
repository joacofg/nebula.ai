...
- [ ] **PLAT-01**: Operator can deploy Nebula through one documented self-hosted path without manual code edits
...
- [ ] **PLAY-01**: Operator can send a test prompt through Nebula from a playground UI
